    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto text-center text-white">
        <h2 className="text-3xl md:text-4xl font-bold leading-tight">
          Your Support Can Change Lives Today
        </h2>

        <p className="mt-4 text-gray-200 max-w-2xl mx-auto text-lg leading-7">
          Every contribution helps provide education, medical aid, and hope to 
          children and communities in need. Join us and make a difference now.
        </p>
